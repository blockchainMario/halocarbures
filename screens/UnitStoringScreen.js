...
class UnitStoringScreen extends Component {
  state = {
    unit: null,
    storingDate: "",
  }
  ...
  savestoring = (navigation, t) => {
    var valid = true;
    if (valid) {
    //alert("http://18.190.29.217:8080/api/v1/savestoring/"+GLOBALS.UUID+"/"+this.state.storingDate);
    axios.get("http://18.190.29.217:8080/api/v1/savestoring/"+GLOBALS.UUID+"/"+this.state.storingDate
    , {
      headers: {
            ...
            <View style={styles.body}>
                <View style={styles.bodyContent}>
                    <View style={styles.line}>
                        ...
                        <NunitoBoldText style={styles.info}>{this.state.storingDate}</NunitoBoldText>
                    </View>
...
export default withTranslation()(UnitStoringScreen);
