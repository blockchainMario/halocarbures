...
class UnitDismantlingScreen extends Component {
  state = {
    unit: null,
    dismantlingDate: "",
  }
  ...
  savedismantling = (navigation, t) => {
    var valid = true;
    if (valid) {
    //alert(GLOBALS.ENDPOINT+"savedismantling/"+GLOBALS.UUID+"/"+this.state.dismantlingDate);
    axios.get(GLOBALS.ENDPOINT+"savedismantling/"+GLOBALS.UUID+"/"+this.state.dismantlingDate
    , {
      headers: {
            ...
            <View style={styles.body}>
                <View style={styles.bodyContent}>
                    <View style={styles.line}>
                        ...
                        <NunitoBoldText style={styles.info}>{this.state.dismantlingDate}</NunitoBoldText>
                    </View>
...
export default withTranslation()(UnitDismantlingScreen);
