...
class NewBinScreen extends Component {
  ...
  componentDidMount() {
    ...
    //alert(GLOBALS.ENDPOINT+"list/"+GLOBALS.ORGANIZATION+"/binTypeTable");
    axios.get(GLOBALS.ENDPOINT+"list/"+GLOBALS.ORGANIZATION+"/binTypeTable", {
        headers: {
  ...
  savebin = (navigation, t) => {
    ...
    if (valid) {
    //alert(GLOBALS.ENDPOINT+"savebin/"+GLOBALS.ORGANIZATION+"/"+GLOBALS.UUID+"/"+this.state.creationDate+"/"+this.state.binType);
    axios.get(GLOBALS.ENDPOINT+"savebin/"+GLOBALS.ORGANIZATION+"/"+GLOBALS.UUID+"/"+this.state.creationDate+"/"+this.state.binType, {
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer '+GLOBALS.BEARERTOKEN
      }
